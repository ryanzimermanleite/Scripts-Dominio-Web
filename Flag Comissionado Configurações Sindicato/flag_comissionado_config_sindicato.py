...
def abre_tela_sindicato_empregados():
    ...
    time.sleep(3)
    while not _find_img('config_aba.png', conf=0.9):
        time.sleep(1)
        _click_img('comissionado.png', conf=0.9)
        time.sleep(3)
    time.sleep(1)
    _click_img('configuracoes.png', conf=0.9)

def consulta_comissionado(andamentos, texto_extraido):
    # Função para verificar e clicar nas imagens
    time.sleep(1)
    if _find_img(f'pagar_ok.png', conf=1):
        status2 = 'OK'
    else:
        while not _find_img(f'pagar_ok.png', conf=1):
            print('1')
            _click_img(f'pagar.png', conf=0.9)
            time.sleep(5)
            _click_img('configuracoes.png', conf=0.9)
            time.sleep(1)
        time.sleep(3)
...
#
    while True:
        ...
        resultado = consulta_comissionado(andamentos, texto_extraido)
...
if __name__ == '__main__':
    andamentos = 'Flag Comissionado Configurações Sindicato'
