...
def flag_nao_calcular_folha_plr_demitido(cod, cnpj, nome):
    ...
    while not _find_img('nao_calcular.png', conf=0.9):
        time.sleep(1)
        _click_position_img('dsr.png', '-', pixels_x=35, conf=0.9)
        time.sleep(1)
    time.sleep(1)

    while not _find_img('nao_calcular_ok.png', conf=1):
        time.sleep(1)
        _click_img('nao_calcular.png', conf=0.9)
        time.sleep(1)
        _click_position_img('dsr.png', '-', pixels_x=35, conf=0.9)
        time.sleep(3)
    time.sleep(1)
...
def run(controle):
    ...
    for count, empresa in enumerate(empresas[index:], start=1):
        ...
        while True:
            ...
            resultado = flag_nao_calcular_folha_plr_demitido(cod, cnpj, nome)
...
if __name__ == '__main__':
    print('teste')
    try:
        andamentos = 'Flag Não Calcular a Folha de PLR Demitido'
