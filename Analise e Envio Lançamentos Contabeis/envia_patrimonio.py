...
def patrimonio(empresa, andamentos):
    ...
    if status == 'Parametro Errado':
        ...
        p.press('l')
        time.sleep(3)
        if _find_img('nao_informado.png', conf=0.9):
            print('entrou 1')
            _escreve_relatorio_csv(';'.join([cod, cnpj, 'conta patrimonial não informada']), nome=andamentos)
        ...
        p.press('l')
        time.sleep(3)
        if _find_img('venda_nao.png', conf=0.9):
            print('entrou 4')
            _escreve_relatorio_csv(';'.join([cod, cnpj, 'conta patrimonial não informada']), nome=andamentos)
            p.press('esc', presses=5)
            return 'ok'
        ...
        if _find_img('aviso_fornecedor.png', conf=0.9):
            ...
            if _find_img('ass_fornecedor.png', conf=0.9):
                ...
                return 'ok'
            print('não imune')
            while not _find_img('contas_sucesso.png', conf=0.9):
                time.sleep(3)
                p.press('r')
