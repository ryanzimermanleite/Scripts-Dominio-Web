...
def consulta_rescisao(andamentos, texto_extraido):
    time.sleep(1)
    status2 = 'Flag Desmarcada'
    if not _find_img('medias_nao.png', conf=1):
        while not _find_img(f'medias_nao.png', conf=1):
...
if __name__ == '__main__':
    andamentos = 'Remove Flag Médias Rescisão Sindicato'
